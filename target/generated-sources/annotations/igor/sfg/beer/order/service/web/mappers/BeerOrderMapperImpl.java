...
import igor.sfg.beer.order.service.web.model.BeerOrderDto.BeerOrderDtoBuilder;
import igor.sfg.beer.order.service.web.model.BeerOrderLineDto;
...
public class BeerOrderMapperImpl implements BeerOrderMapper {
    ...
    protected igor.sfg.beer.order.service.web.model.OrderStatusEnum orderStatusEnumToOrderStatusEnum(OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }

        igor.sfg.beer.order.service.web.model.OrderStatusEnum orderStatusEnum1;

        switch ( orderStatusEnum ) {
            case NEW: orderStatusEnum1 = igor.sfg.beer.order.service.web.model.OrderStatusEnum.NEW;
            break;
            case READY: orderStatusEnum1 = igor.sfg.beer.order.service.web.model.OrderStatusEnum.READY;
            break;
            case PICKED_UP: orderStatusEnum1 = igor.sfg.beer.order.service.web.model.OrderStatusEnum.PICKED_UP;
            break;
    ...
    protected OrderStatusEnum orderStatusEnumToOrderStatusEnum1(igor.sfg.beer.order.service.web.model.OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }
